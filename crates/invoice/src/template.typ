...
#pad(x: 30pt)[
  #grid(
    ...
    [Invoice status], [#text(fill: rgb("#008000"), weight: "black")[{{INVOICE_STATUS}}]],
    [Issued on], [{{DATE_OF_ISSUE}}],
    [Paid on], [{{DATE_OF_PAYMENT}}],
  )
]
#v(20pt)
#pad(x: 30pt)[
    ...
    align(left)[
      *Bill to* \
      #pad(x: 0pt)[
        {{LEADER_NAME}} \
        {{LEADER_ADDRESS}}
        #link("mailto:{{LEADER_EMAIL}}")[{{LEADER_EMAIL_AT}}]
      ]
    ],
  )
]
...
#pad(x: 30pt)[
  #text(
    "Paid ₹{{AMOUNT_PAID}} on {{DATE_OF_PAYMENT}}.",
    weight: "black",
    size: 15pt,
  )
]
#pad(x: 30pt)[
  #text(
    ...
    Successfully processed online via {{PAYMENT_PROVIDER}}.
  ]
]
#v(10pt)
#pad(x: 30pt)[
  ...
  #table(
    ...
    table.cell(inset: (top: 10pt, bottom: 8pt))[₹ {{UNIT_PRICE}}],
    table.cell(inset: (top: 10pt, bottom: 8pt))[0%],
    table.cell(inset: (top: 10pt, bottom: 8pt))[₹ {{SUBTOTAL_AMOUNT}}],

    table.cell(stroke: none)[],
    table.cell(colspan: 4, stroke: (top: 0.5pt + rgb("#e0e0e0"), bottom: 0.5pt + rgb("#e0e0e0")))[Subtotal],
    table.cell(stroke: (top: 0.5pt + rgb("#e0e0e0"), bottom: 0.5pt + rgb("#e0e0e0")))[₹ {{SUBTOTAL_AMOUNT}}],

    table.cell(stroke: none)[],
    table.cell(colspan: 4, stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[Discount{{DISCOUNT_CODE_LABEL}}],
    table.cell(stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[\-₹ {{DISCOUNT_AMOUNT}}],

    table.cell(stroke: none)[],
    table.cell(colspan: 4, stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[Total excluding tax],
    table.cell(stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[₹ {{TOTAL_EXCL_TAX}}],

    table.cell(stroke: none)[],
    table.cell(colspan: 4, stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[Total tax],
    table.cell(stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[₹ {{TAX_AMOUNT}}],

    table.cell(stroke: none)[],
    table.cell(colspan: 4, stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[Total],
    table.cell(stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[₹ {{TOTAL}}],

    table.cell(stroke: none)[],
    table.cell(colspan: 4, stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[*Amount Paid*],
    table.cell(stroke: (bottom: 0.5pt + rgb("#e0e0e0")))[*₹ {{AMOUNT_PAID}}*],

    table.cell(stroke: none)[],
    table.cell(colspan: 4)[*Balance Due*],
    table.cell[*₹ {{BALANCE_DUE}}*]
  )
